    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => EditProfilePage(
          updateProfile: (String newName, String newUsername, String newEmail, String newBio, String newPassword) {
            setState(() {
              name = newName;
...
class EditProfilePage extends StatefulWidget {
  ...
  const EditProfilePage({Key? key, required this.updateProfile}) : super(key: key);
          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                decoration: const InputDecoration(labelText: 'Username', labelStyle: TextStyle(color: Colors.black)),
              ...
              TextField(
                ...
                decoration: const InputDecoration(labelText: 'Bio', labelStyle: TextStyle(color: Colors.black)),
                maxLines: 3,
                style: const TextStyle(fontSize: 16),
              ),
              const SizedBox(height: 16),
